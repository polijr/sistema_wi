...
urlpatterns = [
    ...
    url(r'^deletar-organizador/(?P<pk>\d+)$', DeletarOrganizador.as_view(), name='Deletar Organizador'),
    url(r'^deletar-empresa/(?P<pk>\d+)$', DeletarEmpresa.as_view(), name='Deletar Empresa'),
    url(r'^deletar-caravaneiro/(?P<pk>\d+)$', DeletarCaravaneiro.as_view(), name='Deletar Caravaneiro'),
