(function($) {
  ...
  // Sliders usados em /regras
  if ($("#slider-interior").length) {
    var sliderInterior = document.getElementById('slider-interior');
    var spanPreçoInterior = document.getElementById('valor-preço-interior');
    var spanPrazoInterior = document.getElementById('valor-prazo-interior');
    var spanPerfInterior = document.getElementById('valor-performance-interior');

    var spanPreçoInterior2 = document.getElementById('preço-interior');
    var spanPrazoInterior2 = document.getElementById('prazo-interior');
    var spanPerfInterior2 = document.getElementById('performance-interior');




    noUiSlider.create(sliderInterior, {
      start: [20, 80],
    ...
    sliderInterior.noUiSlider.on('update', function(values, handle) {
      var posicoesInterior = sliderInterior.noUiSlider.get();
      var preçoInterior = Number(posicoesInterior[0]);
      var prazoInterior = posicoesInterior[1] - posicoesInterior[0];
      var performanceInterior = 100 - posicoesInterior[1];
      spanPreçoInterior.innerText = preçoInterior;
      spanPrazoInterior.innerText = prazoInterior;
      spanPerfInterior.innerText = performanceInterior;
    });
